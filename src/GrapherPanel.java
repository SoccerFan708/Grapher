...
public class GrapherPanel extends JPanel implements ActionListener, KeyListener{
  ...
  // SET_DEFAULTS();
   ...
   public static void main(String[] args) {
      ...
      //SET_DEFAULTS(); 
      GrapherPanel gPanel = new GrapherPanel();
      JFrame gFrame = new JFrame("GRAPHER");
      ...
      SwingUtilities.invokeLater(
         new Runnable() {
            ...
            public void run() {
               ...
               gFrame.add(gPanel, BorderLayout.CENTER);
               gFrame.setVisible(true);
            }
         });
